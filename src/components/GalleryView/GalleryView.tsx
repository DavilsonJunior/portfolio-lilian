      ...
      <GalleryViewContainer className="hero">
        ...
        <GalleryViewImagesContainer data-aos="fade-down">
          ...
          <div className="item-galeria">
            <img
              className="img-galeria"
              src="/images/gallery/gallery-31.png"
              alt="gallery 31"
            />
          </div>
          <div className="item-galeria  w-1 h-2">
          ...
          <div className="item-galeria">
            <img
              className="img-galeria"
              src="/images/gallery/gallery-40.png"
              alt="gallery 40"
            />
          </div>
          <div className="item-galeria  w-1 h-2">
          ...
          <div className="item-galeria">
            <img
              className="img-galeria"
              src="/images/gallery/gallery-45.jpg"
              alt="gallery 45"
            />
          </div>
          <div className="item-galeria">
          ...
          <div className="item-galeria w-1 h-2">
            <img
              className="img-galeria"
              src="/images/gallery/gallery-47.jpg"
              alt="gallery 47"
            />
          </div>
          <div className="item-galeria w-1 h-1">
          ...
          <div className="item-galeria  w-1 h-2">
            <img
              className="img-galeria"
              src="/images/gallery/gallery-50.jpg"
              alt="gallery 50"
            />
          </div>
          <div className="item-galeria w-1 h-1">
            <img
              className="img-galeria"
              src="/images/gallery/gallery-51.jpg"
              alt="gallery 51"
            />
          </div>
          <div className="item-galeria w-1 h-1">
