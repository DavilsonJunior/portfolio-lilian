export const services = [
  ...
  {
    id: 3,
    title: 'Treinamento e orientação para funcionários',
    description:
      'O treinamento dos funcionários ou colaboradores domésticos, capacita-os com métodos mais profissionais e um planejamento de rotina adequado para a sua casa, de modo que as tarefas sejam cumpridas de forma eficiente.'
  },
  {
    id: 4,
