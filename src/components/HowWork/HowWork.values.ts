export const howWorkTopics = [
  ...
  },
  {
    ...
    title: 'Garantia',
    description:
      'Após a realização do projeto, faço a visita de retorno para verificar a sua adaptação à organização e faço os ajustes necessários. Essa visita acontece entre 30 a 40 dias após a realização da organização.'
  }
];
